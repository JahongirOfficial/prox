    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <aside className="fixed left-0 top-0 h-full w-64 bg-slate-800/50 backdrop-blur-xl border-r border-slate-700/50 p-6">
        ...
        <nav className="space-y-2">
          ...
          <Link to="/leaderboard" className="block px-4 py-3 bg-gradient-to-r from-blue-500/20 to-purple-600/20 border border-blue-500/30 text-white rounded-lg flex items-center gap-3 transition">
      ...
      <main className="ml-64 p-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-slate-400">Eng yaxshi o'quvchilar reytingi</p>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-slate-700/30">
                  <tr>
                    <th className="px-6 py-4 text-left text-slate-300 font-medium">Reyting</th>
                    <th className="px-6 py-4 text-left text-slate-300 font-medium">Talaba</th>
                    <th className="px-6 py-4 text-left text-slate-300 font-medium">Ball</th>
                    <th className="px-6 py-4 text-left text-slate-300 font-medium">Darslar</th>
                    <th className="px-6 py-4 text-left text-slate-300 font-medium">Progress</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td colSpan={5} className="px-6 py-16 text-center text-slate-400">
                      <span className="material-symbols-outlined text-6xl mb-3 opacity-50">leaderboard</span>
                      <p className="text-lg">Hozircha ma'lumot yo'q</p>
                      <p className="text-sm mt-2">O'quvchilar darslarni boshlagach, reyting paydo bo'ladi</p>
                    </td>
                  </tr>
                </tbody>
              </table>
