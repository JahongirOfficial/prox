      ...
      >
        ...
        <div className="p-4 border-b border-slate-700">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-bold text-lg">Learning</span>
          </div>
        </div>
        {/* Menu Content */}
                ...
                modules.map((mod, idx) => {
                  ...
                  return (
                    <div key={modId}>
                      ...
                      {isOpen && (
                        <div className="pl-4 pt-1 pb-0.5 flex flex-col gap-1" style={{ marginTop: '5px' }}>
            ...
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-xs">
                  {userLoading ? "..." : user ? user.fullName.charAt(0).toUpperCase() : "L"}
                </span>
              </div>
              <div className="flex-1">
                {userLoading ? (
                  ...
                  <>
                    <div className="text-white font-semibold text-xs truncate">Learning Student</div>
                    <div className="text-gray-400 text-xs">Online</div>
                  </>
                )}
              </div>
